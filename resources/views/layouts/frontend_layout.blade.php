...
<head>
    ...
    <link href="{{ asset('frontend/assets/css/components/cards/card.css') }}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/elements/alert.css') }}">
    <style>
        /*
...
<body class="sidebar-noneoverflow">
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo"
                        src="{{ asset('frontend/assets/img/90x90.jpg') }}"> <span
            ...
            <ul class="navbar-item flex-row nav-dropdowns ml-auto">
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            <img src="{{ asset('frontend/assets/img/90x90.jpg') }}" class="img-fluid">
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="#menu{{$mainmenu->id  }}" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle autodroprown">
                            <div class="">
                                <span>{{ $mainmenu->main_menu }}</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled" id="menu{{$mainmenu->id  }}"
                            data-parent="#topAccordion">
                            @foreach ($mainmenu->submenus as $submenu)
                            <li>
                                <a href="/products/{{ $submenu->id }}">{{ $submenu->submenu }}</a>
                            </li>
                            @endforeach
                        </ul>
                        @endif
    ...
    <script src="{{ asset('frontend/plugins/highlight/highlight.pack.js') }}"></script>
